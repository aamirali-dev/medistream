"""
This is an auto generated file using: py manage.py inspectdb --include-views > datalake/models.py
This file has been modified to add primary and foriegn keys as these couldn't be infered automatically from database
"""
