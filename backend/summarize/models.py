...
class Resultsview(models.Model):
    result_date_time = models.DateTimeField(db_column='Result Date/Time')  # Field name made lowercase. Field renamed to remove unsuitable characters.
    order_no = models.CharField(db_column='Order No', max_length=50, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    patient_id = models.IntegerField(db_column='Patient ID')  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class Vitalsview(models.Model):
    vitalsid = models.CharField(db_column='VitalsID', max_length=500, blank=True, null=True)  # Field name made lowercase.
    ...
    patientid = models.CharField(db_column='PatientID', max_length=500, blank=True, null=True)  # Field name made lowercase.
    ...
    noteid = models.CharField(db_column='NoteID', max_length=500, blank=True, null=True)  # Field name made lowercase.
